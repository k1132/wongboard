...
/* USB HID device Configuration Descriptor 
   Describes what kind of HID device(s) this usb device is. 
*/
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  0x01,//0x02,         /*nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse*/	//changed to implement keyboard instead of mouse
...
/*  Report descriptor. Generated by STM32CUBE but you can make your own using
    the HID Descriptor Tool GUI. http://www.usb.org/developers/hidpage/dt2_4.zip
	also see  http://www.instructables.com/id/USB-Wii-Classic-Controller/step5/USB-HID-Reports-and-Report-Descriptors/
	http://www.microchip.com/forums/m438695.aspx
	HID Usage tables http://www.usb.org/developers/hidpage/
*/
...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE]  __ALIGN_END =
{
	...
	//total size 10 bytes. put current state of keyboard in bytes 4-11.
	
	/*generic mouse using hid descriptor tool 
