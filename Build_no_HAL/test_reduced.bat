...
:: make Cflags
set INCLUDE_ARGS=-I%CMSIS_INC% -I%STM32CUBE_INC% -I%DEVICE_INC%
set CFLAGS= -DSTM32F072xB -mcpu=cortex-m0 -mthumb -Wall %INCLUDE_ARGS% -ffunction-sections -fdata-sections
